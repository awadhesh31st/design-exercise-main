...
const RadioGroup = React.forwardRef<HTMLDivElement, RadioGroupProps>(({ className, value, defaultValue, onValueChange, name, ...props }, ref) => {
  ...
  return (
    <RadioGroupContext.Provider value={{ value: actualValue, onValueChange: handleValueChange, name }}>
      <div ref={ref} data-slot="radio-group" className={cn('grid gap-3', className)} role="radiogroup" {...props} />
